...
class Finder:
    ...
    def get_web_content(self) -> None:
        ...
        response: bytes = _send_http_get_request(self._url)
        self._raw_content = bs(response, "html.parser")
...
def _send_http_get_request(url: str) -> bytes:
